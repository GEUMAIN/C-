...
public class TypeWriterEffect10:MonoBehaviour
{
    ...
    public void end()
    {
        ...
        timetext2.SetActive(false);
        script14Instance.enabled = true;
        Debug.Log(problemnum.clearproblemnum);
        Debug.Log(problemnum.failproblemnum);
