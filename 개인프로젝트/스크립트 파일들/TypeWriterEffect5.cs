...
public class TypeWriterEffect5 : MonoBehaviour
{
    ...
    public void end()
    {
        ...
        SHOP.currentMoney += 1000;
        tip1.SetActive(false);
        tip2.SetActive(false);
        tip3.SetActive(true);
        this.enabled = false;
        script6Instance.enabled = true;
        script6Instance.StartTalk(script6Instance.Txtdialogue);
    }
    public void Hind()
    {
        hindrance1.SetActive(true);
    }
    public void Hind2()
    {
        hindrance1.SetActive(false);
        hindrance2.SetActive(true);
    }
    private void Update()
    {
